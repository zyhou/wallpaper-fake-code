    ...
    return (
        <div className="font-medium flex justify-center text-white">
            <button
                ...
                className="flex items-center rounded-l-md p-3 my-0.5 transition duration-300 ease-in-out ring ring-blue focus:outline-none focus:ring bg-blue-600 hover:bg-blue-700"
            >
                <svg
            ...
            <select
                className="cursor-pointer w-full transition duration-300 ease-in-out border-none ring ring-blue focus:outline-none bg-blue-600 hover:bg-blue-700"
                value={theme.name}
            ...
            <button
                ...
                className="flex items-center rounded-r-md p-3 my-0.5 transition duration-300 ease-in-out ring ring-blue focus:outline-none focus:ring bg-blue-600 hover:bg-blue-700"
            >
                Next
                <svg
                    xmlns="http://www.w3.org/2000/svg"
